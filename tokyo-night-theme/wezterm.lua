...
-- Features: Tokyo Night theme, native multiplexing, tmux-style keybindings, layout presets
...
-- ============================================================================
-- TAB BAR / STATUS BAR (Tokyo Night style)
-- ============================================================================
...
-- Status bar with system info (like tmux tokyo-night: battery, time)
wezterm.on("update-status", function(window, pane)
	...
	window:set_left_status(wezterm.format({
		{ Background = { Color = tokyonight.blue } },
		{ Foreground = { Color = tokyonight.bg } },
		{ Text = "  " .. workspace .. " " },
		{ Background = { Color = tokyonight.bg } },
		{ Text = " " },
	}))

	-- Right status: battery + time (Tokyo Night style)
	window:set_right_status(wezterm.format({
		{ Background = { Color = tokyonight.bg_highlight } },
		{ Foreground = { Color = tokyonight.fg } },
		{ Text = " " .. battery },
		{ Background = { Color = tokyonight.blue } },
		{ Foreground = { Color = tokyonight.bg } },
		{ Text = "  " .. date .. " " },
